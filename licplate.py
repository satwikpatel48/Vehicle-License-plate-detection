...
img = cv2.imread('car0.jpg',cv2.IMREAD_COLOR)
...
# finding the edges using canny edge detection method
edged = cv2.Canny(gray, 30, 200) #Perform Edge detection
cv2.imshow("3- Canney edge detection",edged)
cv2.waitKey(0)
...
cv2.imshow("5- Top 30 contours",img2) #top 30 contours
cv2.waitKey(0)
count=0
